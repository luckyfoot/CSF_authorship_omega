...
__builtins__.input = disable_input
...
if __name__=="__main__":
    ...
    assert approx(find_author.hapax_legomana_ratio(text),0.777777777778),\
    ...
    assert approx(find_author.average_sentence_length(text),17.5),\
